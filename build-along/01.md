...
2. Search replace "#282c37" with `var(--mast-base-color)`.
3. Ditto, replacing "#9baec8" with `var(--mast-primary-color)`.
4. Ditto, replacing "#d9e1e8" with `var(--mast-secondary-color)`.
5. Ditto, replacing "#6364ff" with `var(--mast-highlight-color)`.
