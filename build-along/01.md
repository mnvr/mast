...
I then gave it the following message:

> Thank you, that is what I wanted. There were some elements that you missed
> (e.g.  `overflow-x: hidden` should've been removed, but false positives are
> better than accidentally removing colors). Thanks again. I will now give you
> more parts of the same file.
>
> So that the instructions don't move out of your context window, I will repeat
> the instructions.
>
...
So I repeated it with shorter < 1000 line snippets.
